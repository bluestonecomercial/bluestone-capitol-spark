        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 border-2 border-gold text-gold font-semibold px-8 py-4 rounded-lg text-base hover:bg-gold hover:text-foreground transition-colors active:scale-[0.97]"
            >
